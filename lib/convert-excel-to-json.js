...
const excelToJson = (function() {
    ...
    function getSheetCellValue(sheetCell) {
		...
		if (sheetCell.t === 'n' || sheetCell.t === 'd') {
			return sheetCell.v;
		} else {
			if (sheetCell.l && sheetCell.l.Target) {
				// 链接
				return {
					text: sheetCell.w && sheetCell.w.trim && sheetCell.w.trim() ? sheetCell.w.trim() : sheetCell.w,
					link: sheetCell.l && sheetCell.l.Target ? sheetCell.l.Target : ''
				};
			} else {
				return (sheetCell.w && sheetCell.w.trim && sheetCell.w.trim()) || sheetCell.w;
			}
		}
    };
